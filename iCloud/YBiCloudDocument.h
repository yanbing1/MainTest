...
@class YBiCloudDocument;
@protocol YBiCloudDocumentDelegate;
@interface YBiCloudDocument : UIDocument
...
@property (weak, nonatomic) id <YBiCloudDocumentDelegate> delegate;
...
@protocol YBiCloudDocumentDelegate <NSObject>
